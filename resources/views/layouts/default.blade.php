...
<head>
	...
	@if(isset($isProduct) && $isProduct && !preg_match("|users/|",Request::path()) && !preg_match("|/add|",Request::path()) && !preg_match("|/edit|",Request::path()) && !preg_match("|admin-user/|",Request::path()))
	<script>
